...
\null\vfill
  ...
  {
    \scalebox{0.75}{\input{src/fig/qelDiagram}}
  }
  ...
  \twocolumn
  {
    \centering\scalebox{0.5}{\input{src/fig/nucleon}}
  }
  {
    \sep
    \begin{itemize}
...
\null\vfill
  ...
  {
    \centering\scalebox{0.75}{\input{src/fig/resDiagram}}
  }	
...
\null\vfill
  ...
  {
    \scalebox{0.75}{\input{src/fig/disDiagram}}
  }
  ...
  {
    \sep\sep\sep
    \centering\scalebox{0.75}{\input{src/fig/hadronization}}
  }
  {
    \begin{itemize}
...
\null\vfill
  ...
  \centering\input{src/fig/pionProduction}
...
\null\vfill
  ...
  {
    \centering\scalebox{0.5}{\input{src/fig/ia}}
  }
...
\null\vfill
  ...
  \twocolumn
  {
    ...
    \rput[c](7.5, 2.0){\scalebox{0.75}{\input{src/fig/src}}}
  }
  {
    \vspace*{-10pt}
...
\null\vfill
  ...
  \twocolumn
  {
    \input{src/fig/mecNames}
  }
  {
    \rput[c](6.5, 1.6){\scalebox{0.75}{\input{src/fig/src2}}}
  }
...
\null\vfill
  ...
  {
    \sep\sep
    \scalebox{0.75}{\input{src/fig/cohDiagram}}
  }
...
\null\vfill
  ...
  \input{src/fig/neutrinoInteractions}
